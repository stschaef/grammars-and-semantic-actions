-- A uniform definition of residuals for all theories.  Per-theory definitions
-- are definitionally nicer; this trades that for uniformity.
...
-- Unlike `HoleElems`, independent of a full tuple: filling it computes the tuple.
