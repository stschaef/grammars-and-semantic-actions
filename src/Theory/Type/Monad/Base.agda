...
-- Bespoke rather than an upstream categorical monad: `ℓT` shifts levels, so
-- the record lives in Typeω, beyond any fixed-level monad interface.
record Monad : Typeω where
  ...
  -- every covariant answer functor gets its `Ans-≅` laws from these
