...
-- One type checker, three answers; the tests are `refl`.
...
-- shadowing: `konst`'s body returns the *outer* binder
...
-- `ND` finds exactly one derivation: typing is a proposition
