{- Every bag is empty or a generator times a rest, truncated: `comm` leaves
   the generator undetermined.  Truncated, the total space IS a model, so
   this is again just a fold. -}
