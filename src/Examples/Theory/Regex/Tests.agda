...
module Examples.Theory.Regex.Tests where
...
open import Theory.Instances.Monoid.Regex.Decide L _≟L_ (ℓ-suc ℓ-zero)
...
-- `a b *` -- the case the two-tag fold exists for
...
-- classes: complement is what finite disjunction cannot do over a large alphabet
