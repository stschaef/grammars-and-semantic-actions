...
{- Untyped lambda terms, predictively.
   ...
   Parenthesised application: left-recursion-free, terminal-led, one
...
module Examples.Theory.Combinator.Lambda where
...
-- `Synthesis` builds the table and checks LL(1); empty classes need no `none`
lamRules : Rules Unit
