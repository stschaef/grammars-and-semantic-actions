...
{- `Grammars/Polynomial` written once, run at all three answers; the ND
   enumeration is a singleton since the grammar is left-factored. -}
open import Cubical.Foundations.Prelude
import Cubical.Data.Sum as Sum
import Cubical.Data.Empty as Empty
import Cubical.Data.Equality as Eq

module Examples.Theory.Combinator.Polynomial where
