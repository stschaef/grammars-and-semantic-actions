...
{- Arrow functions and parenthesised member access.
   ...
   LL(*): the two bracket productions share an unbounded prefix; parsed with unbounded lookahead. -}
...
module Examples.Theory.Combinator.Arrow where
...
open import Examples.Theory.Combinator.Bracket
...
isSetTg N = DiscreteEq→isSet (decTg N)
